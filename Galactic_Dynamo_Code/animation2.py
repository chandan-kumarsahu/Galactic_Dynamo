...
A = matrix(len(z), 1+2*rho, sigma, q*Omega*dt/2, 1+2*rho, -rho, sigma, 0, -rho, -rho, 0, 0, -rho, alpha, dalpha_dt, dz, dt)
B = matrix(len(z), 1-2*rho, -sigma, -q*Omega*dt/2, 1-2*rho, rho, -sigma, 0, rho, rho, 0, 0, rho, alpha, dalpha_dt, dz, dt)
